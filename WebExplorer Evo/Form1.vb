...
#Region "Constant Code" 'El codigo de esta region solo se modifica para cambiar el comportamiento del control
    ...
    Sub configureNew(ByVal Target As Uri)
        ...
        PicImage.Image = My.Resources.NewTab
        PicImage.BackColor = Color.Silver
        PicImage.SizeMode = PictureBoxSizeMode.Zoom
        PicImage.Tag = NexusBrowser.Name

        ImgPanel.Padding = New System.Windows.Forms.Padding(3, 6, 3, 6)
    ...
    Sub AddFav(ByVal sender As NexusBrowser.cNexusBrowser)
        ...
        If Not (My.Computer.FileSystem.DirectoryExists(My.Computer.FileSystem.SpecialDirectories.MyDocuments + "\NxWebShip\Fav")) Then
            My.Computer.FileSystem.CreateDirectory(My.Computer.FileSystem.SpecialDirectories.MyDocuments + "\NxWebShip\Fav")
        End If

        Try

            Dim xcount As Integer = IO.Directory.EnumerateDirectories(My.Computer.FileSystem.SpecialDirectories.MyDocuments + "\NxWebShip\Fav").Count + 1
            Dim xRout As String = My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\NxWebShip\Fav\Record-" & xcount.ToString
    ...
    Private Sub PictureBox_MouseClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles PicImage.MouseClick
        ...
        If e.Button = Windows.Forms.MouseButtons.Right Then
            ...
            Panel8.Location = New Drawing.Point(55, Cursor.Position.Y - (32 + Me.Top) - 5)
    ...
    Private Sub PictureBox12_Click(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles PictureBox12.MouseClick, PictureBox12.Click
        If e.Button = Windows.Forms.MouseButtons.Left And addNew = False Then
            addNew = True
            Dim xTrgt As New Uri("http://www.google.com.do")
            configureNew(xTrgt)
        End If
