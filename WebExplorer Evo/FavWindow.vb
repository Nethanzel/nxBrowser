Public Class ContextWindow
    ...
    Private Sub ContextWindow_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For Each Fav As String In IO.Directory.GetDirectories(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\NxWebShip\Fav")
            ...
            DataGridView1.Rows(DTG_Index).Height = 40
    ...
    Private Sub PictureBox3_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs)
